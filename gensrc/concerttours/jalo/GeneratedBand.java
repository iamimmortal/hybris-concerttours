...
public abstract class GeneratedBand extends GenericItem
{
	...
	/** Qualifier of the <code>Band.country</code> attribute **/
	...
	/** Qualifier of the <code>Band.BandCmt</code> attribute **/
	public static final String BANDCMT = "BandCmt";
	/**
	...
	**/
	...
	/**
	* {@link OneToManyHandler} for handling 1:n BANDCMT's relation attributes from 'many' side.
	**/
	protected static final OneToManyHandler<BandComment> BANDCMTHANDLER = new OneToManyHandler<BandComment>(
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Band.BandCmt</code> attribute.
	 * @return the BandCmt
	 */
	public Set<BandComment> getBandCmt(final SessionContext ctx)
	{
		return (Set<BandComment>)BANDCMTHANDLER.getValues( ctx, this );
	}
	 ...
	 * @return the BandCmt
	 */
	public Set<BandComment> getBandCmt()
	{
		return getBandCmt( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>Band.BandCmt</code> attribute. 
	 * @param value the BandCmt
	 */
	public void setBandCmt(final SessionContext ctx, final Set<BandComment> value)
	{
		BANDCMTHANDLER.setValues( ctx, this, value );
	}
	 ...
	 * @param value the BandCmt
	 */
	public void setBandCmt(final Set<BandComment> value)
	{
		setBandCmt( getSession().getSessionContext(), value );
	}
	
	/**
	 * <i>Generated method</i> - Adds <code>value</code> to BandCmt. 
	 * @param value the item to add to BandCmt
	 */
	public void addToBandCmt(final SessionContext ctx, final BandComment value)
	{
		BANDCMTHANDLER.addValue( ctx, this, value );
	}
	 ...
	 * @param value the item to add to BandCmt
	 */
	public void addToBandCmt(final BandComment value)
	{
		addToBandCmt( getSession().getSessionContext(), value );
	}
	
	/**
	 * <i>Generated method</i> - Removes <code>value</code> from BandCmt. 
	 * @param value the item to remove from BandCmt
	 */
	public void removeFromBandCmt(final SessionContext ctx, final BandComment value)
	{
		BANDCMTHANDLER.removeValue( ctx, this, value );
	}
	 ...
	 * @param value the item to remove from BandCmt
	 */
	public void removeFromBandCmt(final BandComment value)
	{
		removeFromBandCmt( getSession().getSessionContext(), value );
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Band.country</code> attribute.
	 * @return the country - country of origin
	 */
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>Band.country</code> attribute. 
	 * @param value the country - country of origin
	 */
